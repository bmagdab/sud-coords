...
\begin{exe}
	...
	\end{dependency}
\end{exe}
\caption{Sentences \texttt{w01031015} from the \texttt{UD\_English-PUD} corpus \citep{pud} and \texttt{GUM\_whow\_ballet-14} from the \texttt{UD\_English-GUM} corpus \citep{Zeldes2017} respectively, modified slightly for clarity.}
\end{figure}
