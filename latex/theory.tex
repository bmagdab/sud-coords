...
\begin{xlist}
	\ex[*] {Did _{\text{S}}[that John failed his exam] surprise Mary?}\label{ex:embedS}
	\ex[] {Did _{\text{NP}}[that fact] surprise Mary?}\label{ex:embedNP}
\end{xlist}
\end{exe}
